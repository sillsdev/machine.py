...
class ThotWordAlignmentModelFactory(WordAlignmentModelFactory):
    ...
    def create_alignment_model(
        ...
        model = ThotSymmetrizedWordAlignmentModel(
            create_thot_word_alignment_model(self._config.thot.word_alignment_model_type, self._direct_model_path),
            create_thot_word_alignment_model(self._config.thot.word_alignment_model_type, self._inverse_model_path),
        )
        model.heuristic = self._config.thot.word_alignment_heuristic
        return model
