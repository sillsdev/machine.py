from typing import Any, Iterator, List, Tuple, TypeVar, overload

from .graph import Graph
from .reportviews import InDegreeView, InEdgeView, OutDegreeView, OutEdgeView
...
class DiGraph(Graph[T]):
    ...
    def to_undirected(self, reciprocal: bool = ..., as_view: bool = ...) -> Graph[T]: ...
