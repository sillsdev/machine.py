...
from machine.jobs import SETTINGS, LocalSharedFileService, SmtEngineBuildJob
from machine.utils import CanceledError, ProgressStatus
...
He hecho la reserva de una habitación tranquila doble con teléfono y televisión a nombre de Rosario Cabedo."""
    ...
    def check_files_created(self) -> bool:
        model_path = self.temp_path / "models" / f"{self.model_name}.zip"
