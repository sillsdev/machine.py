...
def test_segments_no_missing_segments() -> None:
    ...
    assert segments[0].source_segment_refs == [TextSegmentRef(1)]
    assert segments[0].target_segment_refs == [TextSegmentRef(1)]
    ...
    assert segments[2].source_segment_refs == [TextSegmentRef(3)]
    assert segments[2].target_segment_refs == [TextSegmentRef(3)]
...
def test_segments_missing_middle_target_segments() -> None:
    ...
    assert segments[0].target_segment == "target segment 1 .".split()
    assert segments[0].aligned_word_pairs == {AlignedWordPair(0, 0)}
    assert segments[1].source_segment_refs == [TextSegmentRef(3)]
    assert segments[1].target_segment_refs == [TextSegmentRef(3)]
...
def test_segments_missing_last_target_segment() -> None:
    ...
    assert segments[0].target_segment == "target segment 1 .".split()
    assert segments[0].aligned_word_pairs == {AlignedWordPair(0, 0)}
    assert segments[1].source_segment_refs == [TextSegmentRef(2)]
    assert segments[1].target_segment_refs == [TextSegmentRef(2)]
...
def test_segments_missing_first_target_segment() -> None:
    ...
    segments = list(parallel_text.segments)
    assert len(segments) == 2
    assert segments[0].source_segment_refs == [TextSegmentRef(2)]
    assert segments[0].target_segment_refs == [TextSegmentRef(2)]
...
def test_segments_range() -> None:
    ...
    segments = list(parallel_text.segments)
    assert len(segments) == 3
    assert segments[1].source_segment_refs == [TextSegmentRef(2), TextSegmentRef(3)]
    assert segments[1].target_segment_refs == [TextSegmentRef(2), TextSegmentRef(3)]
...
def test_segments_overlapping_ranges() -> None:
    ...
    assert segments[0].source_segment_refs == [TextSegmentRef(1), TextSegmentRef(2), TextSegmentRef(3)]
    assert segments[0].target_segment_refs == [TextSegmentRef(1), TextSegmentRef(2), TextSegmentRef(3)]
...
def test_segments_adjacent_ranges_same_text() -> None:
    ...
    segments = list(parallel_text.segments)
    assert len(segments) == 2
    assert segments[0].source_segment_refs == [TextSegmentRef(1), TextSegmentRef(2)]
    assert segments[0].target_segment_refs == [TextSegmentRef(1), TextSegmentRef(2)]
    ...
    assert segments[1].source_segment_refs == [TextSegmentRef(3), TextSegmentRef(4)]
    assert segments[1].target_segment_refs == [TextSegmentRef(3), TextSegmentRef(4)]
...
def test_get_segments_all_source_segments() -> None:
    ...
    assert segments[1].source_segment_refs == [TextSegmentRef(2)]
    assert segments[1].target_segment_refs == []
    assert segments[1].source_segment == "source segment 2 .".split()
    assert segments[1].target_segment == []
...
def test_segments_same_ref_middle_many_to_many() -> None:
    ...
    assert segments[2].source_segment_refs == [TextSegmentRef(2)]
    assert segments[2].target_segment_refs == [TextSegmentRef(2)]
    assert segments[2].source_segment == "source segment 2-1 .".split()
    assert segments[2].target_segment == "target segment 2-2 .".split()
    assert segments[3].source_segment_refs == [TextSegmentRef(2)]
    assert segments[3].target_segment_refs == [TextSegmentRef(2)]
    assert segments[3].source_segment == "source segment 2-2 .".split()
    assert segments[3].target_segment == "target segment 2-1 .".split()
    assert segments[4].source_segment_refs == [TextSegmentRef(2)]
    assert segments[4].target_segment_refs == [TextSegmentRef(2)]
...
def test_get_segments_same_verse_ref_one_to_many() -> None:
    ...
    parallel_text = ParallelText(source_text, target_text, MemoryTextAlignmentCollection("MAT"))
    segments = list(parallel_text.segments)
    assert len(segments) == 3
    assert segments[1].source_segment_refs == [VerseRef.from_string("MAT 1:2", ORIGINAL_VERSIFICATION)]
    assert segments[1].target_segment_refs == [
        VerseRef.from_string("MAT 1:2", versification),
        VerseRef.from_string("MAT 1:3", versification),
    ]
    assert segments[1].source_segment == "source chapter one, verse two .".split()
    assert segments[1].target_segment == "target chapter one, verse two . target chapter one, verse three .".split()
...
def segment(
    ...
    return TextSegment(
        key.book if isinstance(key, VerseRef) else "text1",
        TextSegmentRef(key) if isinstance(key, int) else key,
