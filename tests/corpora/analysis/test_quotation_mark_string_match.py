...
def test_has_leading_closing_quotation_mark() -> None:
    standard_english_quote_convention = QuoteConvention(
        "standard_english",
        [
            SingleLevelQuoteConvention("\u201c", "\u201d"),
    ...
    normalized_english_quote_convention_set = QuoteConventionSet([standard_english_quote_convention.normalize()])

    quotation_mark_string_match = QuotationMarkStringMatch(
        TextSegment.Builder().set_text("sample\u2019\u201d text").build(), 7, 8
    )
    assert quotation_mark_string_match.has_leading_closing_quotation_mark(standard_english_quote_convention_set)
    assert not quotation_mark_string_match.has_leading_closing_quotation_mark(normalized_english_quote_convention_set)
    ...
    assert not quotation_mark_string_match.has_leading_closing_quotation_mark(standard_english_quote_convention_set)
    assert quotation_mark_string_match.has_leading_closing_quotation_mark(normalized_english_quote_convention_set)
...
def test_has_trailing_closing_quotation_mark() -> None:
    standard_english_quote_convention = QuoteConvention(
        "standard_english",
        [
            SingleLevelQuoteConvention("\u201c", "\u201d"),
    ...
    assert quotation_mark_string_match.has_trailing_closing_quotation_mark(standard_english_quote_convention_set)
    assert not quotation_mark_string_match.has_trailing_closing_quotation_mark(normalized_english_quote_convention_set)

    quotation_mark_string_match = QuotationMarkStringMatch(
        TextSegment.Builder().set_text('sample\u2019" text').build(), 6, 7
    )
    assert not quotation_mark_string_match.has_trailing_closing_quotation_mark(standard_english_quote_convention_set)
    assert quotation_mark_string_match.has_trailing_closing_quotation_mark(normalized_english_quote_convention_set)
