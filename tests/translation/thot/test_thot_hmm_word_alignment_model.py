...
from thot_test_helpers import TOY_CORPUS_HMM_PATH

from machine.translation import SymmetrizedWordAlignmentModel, WordAlignmentMatrix
from machine.translation.thot import ThotHmmWordAlignmentModel
...
def test_get_best_alignment() -> None:
    ...
    assert matrix == WordAlignmentMatrix(9, 8, {(0, 5), (1, 6), (3, 7), (4, 0), (4, 1), (5, 2), (6, 3), (7, 4)})
...
def test_get_best_alignments() -> None:
    ...
    assert matrices == [
        WordAlignmentMatrix(8, 8, {(0, 0), (0, 1), (0, 2), (3, 3), (6, 4), (5, 5), (6, 6), (7, 7)}),
        WordAlignmentMatrix(6, 9, {(4, 1), (5, 2), (1, 3), (2, 4), (4, 5), (4, 6), (4, 7), (5, 8)}),
    ]
