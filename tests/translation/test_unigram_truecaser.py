...
from machine.corpora import MemoryText, Text, TextCorpus, TextRow, TextRowFlags
from machine.translation import UnigramTruecaser, UnigramTruecaserTrainer
...
def test_truecase_trainer() -> None:
